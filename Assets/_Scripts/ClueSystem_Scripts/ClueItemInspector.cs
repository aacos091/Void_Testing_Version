...
public class ClueItemInspector : MonoBehaviour
{
    ...
    public bool touchControlled = true;
	...
	private CameraController voidCamControl; 
...
//				rb.constraints = RigidbodyConstraints.FreezeRotationZ;
	...
	//01-23-18 Will Tang: method to move camera off focus from ship to inspect clue clone
